...
$form.BackColor = [System.Drawing.Color]::FromArgb(249, 250, 251) # Off-White
...
$sysInfoAction = {
    ...
    } catch { $outputBox.AppendText("Error loading system info.") }
}
...
$ipConfigAction = {
    ...
    } catch { $outputBox.AppendText("Error loading network config.") }
}
